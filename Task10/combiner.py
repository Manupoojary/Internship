...
def main(rotated_image, thinnest_point):
    ...
    # function to mark thinnest point on the ruler
    focal_point=point_finder.point(resized_ruler_image,orgi_img_thinnest_point)
    return combined_image,focal_point
